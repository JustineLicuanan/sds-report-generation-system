...
import { OrganizationNotificationPopover } from '~/components/notification-popover';
    ...
    <header className="sticky top-0 z-50 w-full bg-c-primary text-c-primary-foreground">
      <section className="container flex h-14 items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <MobileSidebar className="md:hidden" isOrganization />
        ...
        <div className="flex flex-1 items-center justify-end gap-2 md:gap-4">
          ...
          <OrganizationNotificationPopover />

          <AccountDropdown isOrganization>
            <Avatar>
              <AvatarImage />
