...
export default function AddInflowFinancialStatementPage() {
  ...
  const { monthlyID, FSInflowID } = router.query;
  ...
  const deleteFSInflowRow = api.shared.FSInflowRow.delete.useMutation({
    ...
    <>
      ...
      <main className="flex">
        ...
        <div id="main-content" className="mx-4 my-4  w-full  gap-8">
          ...
          <div className="text-medium text-lg">{reportSem?.term} SEMESTER - [MONTH]</div>
          ...
          <div className="mt-4 flex min-h-[40vh] w-full flex-col gap-2 rounded-sm px-4 py-2 shadow-[0_1px_5px_0px_rgba(0,0,0,0.50)]">
            <div className="flex justify-end gap-2">
              <button
                ...
                onClick={() =>
                  router.push({
                    pathname: `${paths.ORGANIZATION}${paths.ORGANIZATION_REPORTS}${paths.FINANCIAL_STATEMENT}/${monthlyID}${paths.MODIFY_FINANCIAL_STATEMENT}${paths.INFLOWS}/${FSInflowID}${paths.COLLECTION_ROW}${paths.CREATE}`,
                    ...
                    <td className="border border-x-0 border-black py-2 text-base">
                      <div className="flex justify-center gap-2">
                        <button
                          ...
                          onClick={() =>
                            router.push({
                              pathname: `${paths.ORGANIZATION}${paths.ORGANIZATION_REPORTS}${paths.FINANCIAL_STATEMENT}/${monthlyID}${paths.MODIFY_FINANCIAL_STATEMENT}${paths.INFLOWS}/${FSInflowID}${paths.COLLECTION_ROW}/${inflowRow.id}${paths.SAVE}`,
                              query: { monthlyID: monthlyID, FSInflowID: FSInflowID },
                            })
                          }
