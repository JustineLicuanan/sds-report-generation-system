...
import { AlertOctagon, Download, Eye, Trash2 } from 'lucide-react';
    ...
    <>
      ...
      <main className="flex">
        ...
        {semester ? (
            ...
            <div className="grid grid-cols-4 grid-rows-2 gap-4">
              ...
              <div className="col-span-2 row-span-1 flex flex-col gap-2 rounded-sm px-4 py-2 shadow-[0_1px_5px_0px_rgba(0,0,0,0.50)]">
                <div className="text-center text-lg font-bold">
                  Organization and School Positions
                </div>
              ...
              <div className="col-span-2 row-span-1 flex flex-col items-center justify-center  gap-2 rounded-sm px-4 py-2 shadow-[0_1px_5px_0px_rgba(0,0,0,0.50)]">
                ...
                <div className="text-center font-medium">
                  Input the Actual Cash in this semester.
                </div>
                <form
          ...
          <div id="main-content" className="flex w-full flex-col items-center justify-center gap-2">
            <AlertOctagon className="h-32 w-32 text-destructive" />

            <h1 className="text-center text-3xl text-destructive">
              There is no active semester for Financial Statement!
            </h1>
          </div>
        )}
      </main>
