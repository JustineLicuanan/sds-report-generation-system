...
type CreateFSInflowRowInputs = z.infer<typeof schemas.shared.inflowCollectionRowFS.create>;
...
export default function CreateCollectionRowPage() {
  ...
  const createFSInflowRowForm = useForm<CreateFSInflowRowInputs>({
    ...
    values: {
      inflowCollectionId: inflowId as string,
  ...
  const createFSInflowRow = api.shared.inflowCollectionRowFS.create.useMutation({
