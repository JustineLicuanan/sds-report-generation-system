    ...
    <>
      ...
      <main className="flex">
        ...
        <div className="mx-3 mt-4 flex h-[87vh] w-full">
          <div className="ms-5 h-[87vh] max-w-5xl  rounded-3xl px-5 py-5 shadow-[0_4px_25px_0px_rgba(0,0,0,0.25)] md:px-9">
          ...
          {/* COMMENTS */}
          <div className="relative ms-3 h-[87vh] w-full max-w-md  rounded-3xl py-5 shadow-[0_4px_25px_0px_rgba(0,0,0,0.25)]">
